...
func NewRootCommand(lc ListCmd, addCmd AddCmd, deleteCmd DeleteCmd, getCmd GetCmd, authCmd AuthCmd) RootCmd {
	root := &cobra.Command{
		Use:   "pv",
	...
	root.AddCommand(lc, addCmd, deleteCmd, getCmd, authCmd)
